...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (action === 'update') {
      ...
      if (data.actions !== undefined) u.actions = data.actions;
      if (data.nextSteps !== undefined) u.nextSteps = data.nextSteps;
    ...
    console.error('[POST /api/lia-meetings]', message);
